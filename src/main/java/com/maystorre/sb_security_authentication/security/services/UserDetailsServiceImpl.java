...
@Service
public class UserDetailsServiceImpl implements UserDetailsService { //UserDetailsService içinde 1 adet aşağıdaki func var başka bişey yok. 	Needed to rebuild user details for each request based on token.
    @Autowired
